 									...
 									if($ERROR != ""){
								 		...
								 		if(isset($URL[1]) && $URL[1] == "read"){
	  										...
	  										if(isset($URL[2]) && is_numeric($URL[2])){
		 										...
		 										echo '<input id="post_button" type="button" style="width:auto;cursor:pointer;margin:4px;" value="Tất cả đoạn chat">';
		 										echo "</a>";

		 										if(is_array($data)){
			 										echo "<a href='".ROOT."delete/thread/". $data[0]['msgid'] ."'>";
			 										echo '<input id="post_button" type="button" style="width:auto;cursor:pointer;background-color:#b76d40;margin:4px;" value="Xóa đoạn chat này">';
			 										echo "</a>";
			 									}
		 										...
		 										<div style="margin-top:50px;border:1px solid gray;border-radius:5px;; padding: 10px;background-color: white;">
								 						...
								 						<input id="post_button" type="submit" value="Gửi">
								 						<br>
								 		...
								 		if(isset($URL[1]) && $URL[1] == "new"){
	  										...
	  										echo "Bắt đầu tin nhắn mới với:<br><br>";
	  										if(isset($URL[2]) && is_numeric($URL[2])){
