	...
	<div id="post" style="background-color: #eee;">
				...
				if(file_exists($COMMENT['image']))
										{
											...
											$ext = pathinfo($COMMENT['image'],PATHINFO_EXTENSION);
											$ext = strtolower($ext);
											...
											if($ext == "jpeg" || $ext == "jpg"){
												...
												echo "<video src='".ROOT."$COMMENT[image]' controls style='width:100%'></video>";
		...
		?>
		<a href="<?=ROOT?>like/post/<?php echo $COMMENT['postid'] ?>">Thích<?php echo $likes ?></a> . 
