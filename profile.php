...
right:0;
		...
		textarea:focus{outline: 1px solid #166fe5}
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_profile_image(event)" style="text-decoration: none;color:#f0f;" href="<?=ROOT?>change_profile_image/profile">Đổi ảnh đại diện</a> | 
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:#f0f;" href="<?=ROOT?>change_profile_image/cover">Đổi ảnh bìa</a>
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<a href="<?=ROOT?>like/user/<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Theo dõi <?php echo $mylikes ?>" style="margin-right:10px;background-color: #9b409a;width:auto;">
						</a>

						<?php if($user_data['userid'] == $_SESSION['mybook_userid']): ?>
							<a href="<?=ROOT?>messages">
								<input id="post_button" type="button" value="Nhắn tin" style="margin-right:10px;background-color: #1b9186;width:auto;">
							</a>
						<?php else: ?>
				...
				<!-- <a href="<?=ROOT?>home"><div id="menu_buttons">Trang chủ</div></a> -->
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/about"><div id="menu_buttons">Giới thiệu</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/followers"><div id="menu_buttons">Theo dõi bạn</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/following"><div id="menu_buttons">Đang theo dõi</div></a>
				<a href="<?=ROOT?>profile/<?php echo $user_data['userid'] ?>/photos"><div id="menu_buttons">Ảnh</div></a>
				
				<?php 
					if($user_data['userid'] == $_SESSION['mybook_userid']){
						
						echo '<a href="'.ROOT. 'profile/'.$user_data['userid'].'/groups"><div id="menu_buttons">Nhóm</div></a>';
						echo '<a href="'.ROOT. 'profile/'.$user_data['userid'].'/settings"><div id="menu_buttons">Cài đặt</div></a>';
					}
				?>
			</div>
