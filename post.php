	...
	<div id="post">
		...
		?>
		<a onclick="like_post(event)" href="<?=ROOT?>like/post/<?php echo $ROW['postid'] ?>">Thích<?php echo $likes ?></a> 
		...
		<a href="<?=ROOT?>single_post/<?php echo $ROW['postid'] ?>">Bình luận<?php echo $comments ?></a> 
